...
<link rel="stylesheet" href="{{asset('light/assets/css/chatapp.css');}}">
                            ...
                            <div class="chat-history">
                                <ul class="m-b-10">
                                    <li class="clearfix">
                                        ...
                                        <div class="message my-message">Bonjour Mr apetsi, Bienveune dans votre teleconsultation</div>                                    
                                    </li> 
                                    <li class="clearfix">
                                        <div class="message-data text-right">
                                            <span class="message-data-time" >online</span>
                                            <img src="../assets/images/xs/avatar2.jpg" alt="avatar">
                                        </div>
                                        <div class="message other-message float-right"> Bonjour Mr faye , Merci Beaucoup </div>
                                    </li>                       
                                    <li class="clearfix">
                                        <div class="message-data">
                                            <span class="message-data-time">10:15 AM, Today</span>
                                        </div>
                                        <div class="message my-message">Vous souhaitez une teleconsultion en video ou en chat ?</div>
                                    </li>
                                    <li class="clearfix">
                                        <div class="message-data text-right">
                                            <span class="message-data-time" >online</span>
                                        ...
                                        <div class="message other-message float-right"> En video svp.</div>
                                    </li> 
                                    <li class="clearfix">
                                        <div class="message-data">
                                            <span class="message-data-time">10:15 AM, Today</span>
                                        </div>
                                        <div class="message my-message">D'accord je lance la video dans un instant.</div>
                                    </li>
                                </ul>
                            </div>
...
<script src="{{asset('light/assets/js/pages/ui/dialogs.js');}}"></script>
</body>
